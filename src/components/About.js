...
const About = () => {
  return (
    <>
      <div>
      <div className='flex flex-col md:flex-row pt-32 lg:pt-40'>
        ...
        <div>
        <h1 className='text-[45px] sm:text-6xl pt-7 font-georgian tracking-wider font-bold md:text-7xl relative'>README</h1>
